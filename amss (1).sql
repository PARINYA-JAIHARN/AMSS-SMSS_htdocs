...
--
-- Table structure for table `bets_book_item`
--

CREATE TABLE `bets_book_item` (
  `id` int(11) NOT NULL,
  `test_id` int(11) NOT NULL,
...
(1, 2551, 'หลักสูตรการศึกษาขั้นพื้นฐาน พุทธศักราช 2551', 1);
...
CREATE TABLE `bets_item` (
  ...
  `solve_doc` varchar(150) NOT NULL DEFAULT '',
  `answer_num` tinyint(4) NOT NULL,
  `question` varchar(250) NOT NULL,
...
--
-- Table structure for table `bets_paper_answer`
--

CREATE TABLE `bets_paper_answer` (
  `id` int(11) NOT NULL,
  `school` int(11) NOT NULL,
  `test_id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
...
--
-- Table structure for table `bets_paper_test_1`
--

CREATE TABLE `bets_paper_test_1` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `bets_qc`
--

CREATE TABLE `bets_qc` (
  `id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
  `test_id` int(11) NOT NULL,
  `rec_date` date NOT NULL
...
--
-- Table structure for table `bets_school_limit`
--

CREATE TABLE `bets_school_limit` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `bets_test` (
  ...
  `class_room` tinyint(4) NOT NULL,
  `level` tinyint(4) NOT NULL DEFAULT '0',
  `other_subject` tinyint(4) NOT NULL DEFAULT '0',
  `level_active` tinyint(4) NOT NULL DEFAULT '0',
  `item_num` int(11) NOT NULL,
  `test_score` int(11) NOT NULL,
  `test_time` int(11) NOT NULL,
  `g1` float NOT NULL,
  `g2` float NOT NULL,
  `test_active` tinyint(4) NOT NULL,
  `open_test` tinyint(4) NOT NULL DEFAULT '0',
  `officer` varchar(13) NOT NULL,
  `rec_date` date NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `bookobec_permission`
--
...
--
-- Table structure for table `bookregister_certificate_sch`
--

CREATE TABLE `bookregister_certificate_sch` (
  `ms_id` int(11) NOT NULL,
...
--
-- Table structure for table `bookregister_command_sch`
--

CREATE TABLE `bookregister_command_sch` (
  `ms_id` int(11) NOT NULL,
  `school_code` varchar(15) NOT NULL,
  `year` int(11) NOT NULL,
  `register_number` int(11) NOT NULL,
...
--
-- Table structure for table `bookregister_receive_filebook_sch`
--

CREATE TABLE `bookregister_receive_filebook_sch` (
  `id` int(11) NOT NULL,
  `school_code` varchar(15) NOT NULL,
  `ref_id` varchar(50) NOT NULL,
  `file_name` varchar(100) NOT NULL,
...
--
-- Table structure for table `bookregister_receive_sch`
--

CREATE TABLE `bookregister_receive_sch` (
  `ms_id` int(11) NOT NULL,
  `school_code` varchar(15) NOT NULL,
  `year` int(11) NOT NULL,
  `register_number` int(11) NOT NULL,
...
--
-- Table structure for table `bookregister_send_filebook_sch`
--

CREATE TABLE `bookregister_send_filebook_sch` (
  `id` int(11) NOT NULL,
  `ref_id` varchar(50) NOT NULL,
  `file_name` varchar(100) NOT NULL,
  `file_des` varchar(100) NOT NULL,
...
--
-- Table structure for table `bookregister_send_sch`
--

CREATE TABLE `bookregister_send_sch` (
  `ms_id` int(11) NOT NULL,
  `school_code` varchar(15) NOT NULL,
  `year` int(11) NOT NULL,
  `register_number` int(11) NOT NULL,
...
--
-- Table structure for table `budget_cancel_deega`
--

CREATE TABLE `budget_cancel_deega` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `budget_deega` (
  ...
  `direct_pay_name` varchar(200) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `budget_key_activity`
--

CREATE TABLE `budget_key_activity` (
  `id` int(11) NOT NULL,
  `budget_year` int(11) NOT NULL,
...
--
-- Table structure for table `budget_money_source`
--

CREATE TABLE `budget_money_source` (
  `id` int(11) NOT NULL,
  `budget_year` int(11) NOT NULL,
...
--
-- Table structure for table `budget_po`
--

CREATE TABLE `budget_po` (
  `id` int(11) NOT NULL,
  `budget_year` int(11) NOT NULL,
...
--
-- Table structure for table `budget_reserve_money`
--

CREATE TABLE `budget_reserve_money` (
  `id` int(11) NOT NULL,
  `budget_year` int(11) NOT NULL,
...
--
-- Table structure for table `budget_return_deega`
--

CREATE TABLE `budget_return_deega` (
  `id` int(11) NOT NULL,
  `budget_year` int(11) NOT NULL,
...
--
-- Table structure for table `building_building`
--
...
--
-- Table structure for table `building_file`
--

CREATE TABLE `building_file` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `building_fix`
--

CREATE TABLE `building_fix` (
  `id` int(11) NOT NULL,
  `school_code` varchar(10) NOT NULL,
  `get_year` varchar(4) NOT NULL,
  `budget` double NOT NULL,
...
--
-- Table structure for table `building_heavy`
--

CREATE TABLE `building_heavy` (
  `id` int(11) NOT NULL,
  `school_code` varchar(10) NOT NULL,
  `get_year` varchar(4) NOT NULL,
  `budget` double NOT NULL,
...
--
-- Table structure for table `building_main`
--

CREATE TABLE `building_main` (
  `id` int(11) NOT NULL,
  `school_code` varchar(10) NOT NULL,
...
--
-- Table structure for table `building_permission`
--
...
--
-- Table structure for table `car_permission`
--

CREATE TABLE `car_permission` (
  `id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
  `p1` tinyint(4) DEFAULT NULL,
  `officer` varchar(13) NOT NULL,
...
INSERT INTO `mail_main` (`ms_id`, `sender`, `subject`, `detail`, `ref_id`, `send_date`) VALUES
(1, '1160100565482', 'test', 'test', '11601005654821714640047', '2024-05-02 15:54:18');
...
INSERT INTO `mail_sendto_answer` (`id`, `ref_id`, `send_to`, `answer`, `answer_time`) VALUES
(1, '11601005654821714640047', '1160100565481', 1, '2024-05-02 16:03:55');
...
--
-- Table structure for table `news_mainitem`
--
...
--
-- Table structure for table `news_permission`
--
...
--
-- Table structure for table `person_delegate`
--
...
INSERT INTO `person_main` (`id`, `person_id`, `prename`, `name`, `surname`, `position_code`, `pic`, `department`, `status`, `person_order`, `officer`, `rec_date`, `birthday`) VALUES
(1, '1160100565481', 'นาย', 'ธนกร', 'บุญสวัสดิ์', 16, '', 0, 0, 0, '7777', '2024-05-02', '2024-04-02');
...
INSERT INTO `person_permission` (`id`, `person_id`, `p1`, `officer`, `rec_date`) VALUES
(1, '1160100565481', 1, '1160100565481', '2024-05-02');
...
--
-- Table structure for table `person_sch_main`
--

CREATE TABLE `person_sch_main` (
  `id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
  `prename` varchar(20) NOT NULL,
  `name` varchar(50) NOT NULL,
...
--
-- Dumping data for table `person_sch_main`
--

INSERT INTO `person_sch_main` (`id`, `person_id`, `prename`, `name`, `surname`, `position_code`, `school_code`, `pic`, `status`, `person_order`, `officer`, `rec_date`, `other`, `birthday`) VALUES
(1, '1160100565482', 'นางสาว', 'เขมิกา', 'เมืองพิล', 1, 10000001, '', 0, 0, '1160100565481', '2024-05-02', 0, '1999-08-23');

-- --------------------------------------------------------

--
-- Table structure for table `person_sch_other`
--

CREATE TABLE `person_sch_other` (
  `id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
  `school_code` int(11) NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `person_sch_position`
--

CREATE TABLE `person_sch_position` (
  `id` int(11) NOT NULL,
  `position_code` int(11) NOT NULL,
  `position_name` varchar(50) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `person_sch_position`
--
...
--
-- Table structure for table `plan_acti_2`
--

CREATE TABLE `plan_acti_2` (
  `id` int(11) NOT NULL,
  `budget_year` int(11) DEFAULT NULL,
...
--
-- Table structure for table `plan_acti_3`
--

CREATE TABLE `plan_acti_3` (
  `id` int(11) NOT NULL,
  `budget_year` int(11) NOT NULL,
...
--
-- Table structure for table `plan_proj_2`
--

CREATE TABLE `plan_proj_2` (
  `id` int(11) NOT NULL,
  `budget_year` int(11) DEFAULT NULL,
  `code_clus` tinyint(4) NOT NULL,
  `code_tegy` char(1) NOT NULL DEFAULT '',
...
--
-- Table structure for table `spacial_student_disabled`
--

CREATE TABLE `spacial_student_disabled` (
  `id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
  `school_code` varchar(15) NOT NULL,
...
--
-- Table structure for table `spacial_student_help1`
--

CREATE TABLE `spacial_student_help1` (
  `id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
  `school_code` varchar(15) NOT NULL,
...
--
-- Table structure for table `spacial_student_permission`
--

CREATE TABLE `spacial_student_permission` (
  `id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
...
--
-- Table structure for table `student_main_expand2`
--

CREATE TABLE `student_main_expand2` (
  `id` int(11) NOT NULL,
  `school_code` varchar(10) NOT NULL,
...
--
-- Table structure for table `student_main_expand3`
--

CREATE TABLE `student_main_expand3` (
  `id` int(11) NOT NULL,
  `school_code` varchar(10) NOT NULL,
  `std_person_id` varchar(13) NOT NULL,
...
--
-- Table structure for table `student_main_main`
--

CREATE TABLE `student_main_main` (
  `id` int(11) NOT NULL,
  `ed_year` int(11) NOT NULL,
...
--
-- Table structure for table `student_main_num`
--

CREATE TABLE `student_main_num` (
  `id` int(11) NOT NULL,
  `school_code` varchar(10) NOT NULL,
  ...
  `c14` int(11) NOT NULL,
  `c15` int(11) NOT NULL,
  `pre_primary_std` int(11) NOT NULL,
  `primary_std` int(11) NOT NULL,
  `secondary_std` int(11) NOT NULL,
...
--
-- Table structure for table `supervision_activity`
--

CREATE TABLE `supervision_activity` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `supervision_activity_rate`
--

CREATE TABLE `supervision_activity_rate` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `supervision_teachtable`
--

CREATE TABLE `supervision_teachtable` (
  `id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
...
--
-- Table structure for table `system_khet`
--
...
--
-- Dumping data for table `system_khet`
--

INSERT INTO `system_khet` (`id`, `code`, `code2`, `type`, `name`, `precis`) VALUES
...
--
-- Table structure for table `system_menugroup`
--

CREATE TABLE `system_menugroup` (
...
--
-- Dumping data for table `system_menugroup`
--
...
(32, 'person', 'ข้อมูลพื้นฐานครูและบุคลากร', 3, 1, 24, 0, '', 0, 'fa fa-user-circle'),
(67, 'mail', '﻿ไปรษณีย์', 1, 1, 6, 0, '', 0, 'fa fa-envelope'),
(97, 'alert', '﻿แจ้งเตือน', 5, 1, 0, 0, '', 0, 'fa fa-info-circle');
...
INSERT INTO `system_module_admin` (`id`, `person_id`, `module`, `officer`, `rec_date`) VALUES
(1, '1160100565481', 'person', '7777', '2024-05-02');

-- --------------------------------------------------------

--
-- Table structure for table `system_office_name`
--

CREATE TABLE `system_office_name` (
  `id` tinyint(4) NOT NULL,
  `office_name` varchar(200) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `system_office_name`
--
...
--
-- Table structure for table `system_school`
--
...
--
-- Dumping data for table `system_school`
--

INSERT INTO `system_school` (`id`, `school_code`, `school_type`, `school_name`, `school_group`) VALUES
(1, '10000001', 1, 'โรงเรียน test001', 0),
(2, '10000002', 1, 'โรงเรียน test002', 0);

-- --------------------------------------------------------

--
-- Table structure for table `system_school_detail`
--

CREATE TABLE `system_school_detail` (
...
--
-- Table structure for table `system_school_group`
--

CREATE TABLE `system_school_group` (
  `id` int(11) NOT NULL,
  `code` int(11) NOT NULL,
  `name` varchar(250) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `system_smss_permission`
--

CREATE TABLE `system_smss_permission` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `system_smss_permission`
--

INSERT INTO `system_smss_permission` (`id`, `school`, `status`) VALUES
(1, '10000001', 1),
(2, '10000002', 1);
...
INSERT INTO `system_sync_code` (`id`, `office_code`, `sync_code`) VALUES
(1, 'xxxx', 'xxxx');

-- --------------------------------------------------------

--
-- Table structure for table `system_sync_smss`
--
...
--
-- Table structure for table `system_sync_smss_2`
--

CREATE TABLE `system_sync_smss_2` (
  `id` int(11) NOT NULL,
  `office_code` int(11) NOT NULL,
  `sync_code` varchar(50) NOT NULL,
  `remote_ip` varchar(50) NOT NULL,
  `smss_url` varchar(150) NOT NULL,
  `officer` varchar(13) NOT NULL,
  `rec_date` date NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `system_sync_smss_2`
--

INSERT INTO `system_sync_smss_2` (`id`, `office_code`, `sync_code`, `remote_ip`, `smss_url`, `officer`, `rec_date`) VALUES
(1, 10000001, '81dc9bdb52d04dc20036dbd8313ed055', '127.0.0.1', 'http://127.0.0.1/smss_10000001//', '1160100565482', '2024-05-02');
...
(2, '1160100565481', 'thanagorn', '8145f89a2e140942df81c1f85efbe670', 1, 1, 0, '1160100565481', '2024-05-02');
...
--
-- Table structure for table `warroom_permission`
--

CREATE TABLE `warroom_permission` (
  `id` int(11) NOT NULL,
  `person_id` varchar(13) NOT NULL,
  `p1` tinyint(4) DEFAULT NULL,
  `p2` tinyint(4) DEFAULT NULL,
...
--
-- Indexes for table `bets_book_item`
--
ALTER TABLE `bets_book_item`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `bets_paper_answer`
--
ALTER TABLE `bets_paper_answer`
  ADD PRIMARY KEY (`id`),
  ADD KEY `school` (`school`),
  ADD KEY `test_id` (`test_id`),
  ADD KEY `person_id` (`person_id`);
...
--
-- Indexes for table `bets_paper_test_1`
--
ALTER TABLE `bets_paper_test_1`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `bets_qc`
--
ALTER TABLE `bets_qc`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bets_school_limit`
--
ALTER TABLE `bets_school_limit`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `bookobec_permission`
--
ALTER TABLE `bookobec_permission`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bookregister_certificate_sch`
--
ALTER TABLE `bookregister_certificate_sch`
  ADD PRIMARY KEY (`ms_id`);
...
--
-- Indexes for table `bookregister_command_sch`
--
ALTER TABLE `bookregister_command_sch`
  ADD PRIMARY KEY (`ms_id`);
...
--
-- Indexes for table `bookregister_receive_filebook_sch`
--
ALTER TABLE `bookregister_receive_filebook_sch`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bookregister_receive_sch`
--
ALTER TABLE `bookregister_receive_sch`
  ADD PRIMARY KEY (`ms_id`);
...
--
-- Indexes for table `bookregister_send_filebook_sch`
--
ALTER TABLE `bookregister_send_filebook_sch`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bookregister_send_sch`
--
ALTER TABLE `bookregister_send_sch`
  ADD PRIMARY KEY (`ms_id`);
...
--
-- Indexes for table `budget_cancel_deega`
--
ALTER TABLE `budget_cancel_deega`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `budget_key_activity`
--
ALTER TABLE `budget_key_activity`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `budget_money_source`
--
ALTER TABLE `budget_money_source`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `budget_po`
--
ALTER TABLE `budget_po`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `budget_reserve_money`
--
ALTER TABLE `budget_reserve_money`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `budget_return_deega`
--
ALTER TABLE `budget_return_deega`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `building_building`
--
ALTER TABLE `building_building`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `building_category`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `cate_code` (`cate_code`);

--
-- Indexes for table `building_file`
--
ALTER TABLE `building_file`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `building_fix`
--
ALTER TABLE `building_fix`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `building_heavy`
--
ALTER TABLE `building_heavy`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `building_main`
--
ALTER TABLE `building_main`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `building_permission`
--
...
--
-- Indexes for table `car_permission`
--
ALTER TABLE `car_permission`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `person_id` (`person_id`);

--
-- Indexes for table `car_report`
--
ALTER TABLE `car_report`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `news_mainitem`
--
ALTER TABLE `news_mainitem`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);
...
--
-- Indexes for table `news_permission`
--
ALTER TABLE `news_permission`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `person_delegate`
--
ALTER TABLE `person_delegate`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `person_sch_main`
--
ALTER TABLE `person_sch_main`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `person_id` (`person_id`),
...
--
-- Indexes for table `person_sch_other`
--
ALTER TABLE `person_sch_other`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `person_sch_position`
--
ALTER TABLE `person_sch_position`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `position_code` (`position_code`);
...
ALTER TABLE `plan_acti`
  ADD PRIMARY KEY (`id`),
  ADD KEY `code_approve` (`code_approve`);

--
-- Indexes for table `plan_acti_2`
--
ALTER TABLE `plan_acti_2`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `plan_acti_3`
--
ALTER TABLE `plan_acti_3`
  ADD PRIMARY KEY (`id`),
  ADD KEY `code_acti` (`code_acti`),
  ADD KEY `code_approve` (`code_approve`),
  ADD KEY `budget_year` (`budget_year`);
...
--
-- Indexes for table `plan_proj_2`
--
ALTER TABLE `plan_proj_2`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `spacial_student_disabled`
--
ALTER TABLE `spacial_student_disabled`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `spacial_student_help1`
--
ALTER TABLE `spacial_student_help1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `spacial_student_permission`
--
ALTER TABLE `spacial_student_permission`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `student_main_expand2`
--
ALTER TABLE `student_main_expand2`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `student_main_expand3`
--
ALTER TABLE `student_main_expand3`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `student_main_main`
--
ALTER TABLE `student_main_main`
  ADD PRIMARY KEY (`id`),
  ADD KEY `person_id` (`person_id`),
  ADD KEY `ed_year` (`ed_year`),
  ADD KEY `school_code` (`school_code`),
  ADD KEY `ed_year_2` (`ed_year`),
  ADD KEY `school_code_2` (`school_code`);

--
-- Indexes for table `student_main_num`
--
ALTER TABLE `student_main_num`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `supervision_activity`
--
...
--
-- Indexes for table `supervision_activity_rate`
--
ALTER TABLE `supervision_activity_rate`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `supervision_teachtable`
--
ALTER TABLE `supervision_teachtable`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `system_khet`
--
ALTER TABLE `system_khet`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indexes for table `system_menugroup`
--
ALTER TABLE `system_menugroup`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `menugroup` (`menugroup`);
...
--
-- Indexes for table `system_office_name`
--
ALTER TABLE `system_office_name`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `system_school`
--
ALTER TABLE `system_school`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `school_code` (`school_code`);

--
-- Indexes for table `system_school_detail`
--
ALTER TABLE `system_school_detail`
  ADD PRIMARY KEY (`school_code`),
  ADD UNIQUE KEY `school_code10` (`school_code10`);

--
-- Indexes for table `system_school_group`
--
ALTER TABLE `system_school_group`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indexes for table `system_smss_permission`
--
ALTER TABLE `system_smss_permission`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `system_sync_smss`
--
ALTER TABLE `system_sync_smss`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `system_sync_smss_2`
--
ALTER TABLE `system_sync_smss_2`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `warroom_permission`
--
ALTER TABLE `warroom_permission`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `person_id` (`person_id`);
...
--
-- AUTO_INCREMENT for table `bets_book_item`
--
ALTER TABLE `bets_book_item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `bets_paper_answer`
--
ALTER TABLE `bets_paper_answer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bets_paper_test_1`
--
ALTER TABLE `bets_paper_test_1`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `bets_qc`
--
ALTER TABLE `bets_qc`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bets_school_limit`
--
ALTER TABLE `bets_school_limit`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `bookobec_permission`
--
ALTER TABLE `bookobec_permission`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `bookregister_certificate_sch`
--
ALTER TABLE `bookregister_certificate_sch`
  MODIFY `ms_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `bookregister_command_sch`
--
ALTER TABLE `bookregister_command_sch`
  MODIFY `ms_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `bookregister_receive_filebook_sch`
--
ALTER TABLE `bookregister_receive_filebook_sch`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bookregister_receive_sch`
--
ALTER TABLE `bookregister_receive_sch`
  MODIFY `ms_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `bookregister_send_filebook_sch`
--
ALTER TABLE `bookregister_send_filebook_sch`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bookregister_send_sch`
--
ALTER TABLE `bookregister_send_sch`
  MODIFY `ms_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `budget_cancel_deega`
--
ALTER TABLE `budget_cancel_deega`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `budget_key_activity`
--
ALTER TABLE `budget_key_activity`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `budget_money_source`
--
ALTER TABLE `budget_money_source`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `budget_po`
--
ALTER TABLE `budget_po`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `budget_reserve_money`
--
ALTER TABLE `budget_reserve_money`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `budget_return_deega`
--
ALTER TABLE `budget_return_deega`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `building_building`
--
ALTER TABLE `building_building`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `building_file`
--
ALTER TABLE `building_file`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `building_fix`
--
ALTER TABLE `building_fix`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `building_heavy`
--
ALTER TABLE `building_heavy`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `building_main`
--
ALTER TABLE `building_main`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `building_permission`
--
ALTER TABLE `building_permission`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `car_main`
--
ALTER TABLE `car_main`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `car_permission`
--
ALTER TABLE `car_permission`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `car_report`
--
ALTER TABLE `car_report`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `news_mainitem`
--
ALTER TABLE `news_mainitem`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `news_permission`
--
ALTER TABLE `news_permission`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `person_delegate`
--
ALTER TABLE `person_delegate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `person_sch_main`
--
ALTER TABLE `person_sch_main`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `person_sch_other`
--
ALTER TABLE `person_sch_other`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `person_sch_position`
--
ALTER TABLE `person_sch_position`
...
--
-- AUTO_INCREMENT for table `plan_acti_2`
--
ALTER TABLE `plan_acti_2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `plan_acti_3`
--
ALTER TABLE `plan_acti_3`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `plan_proj_2`
--
ALTER TABLE `plan_proj_2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `spacial_student_disabled`
--
ALTER TABLE `spacial_student_disabled`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `spacial_student_help1`
--
ALTER TABLE `spacial_student_help1`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `spacial_student_permission`
--
ALTER TABLE `spacial_student_permission`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `student_main_expand2`
--
ALTER TABLE `student_main_expand2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `student_main_expand3`
--
ALTER TABLE `student_main_expand3`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `student_main_main`
--
ALTER TABLE `student_main_main`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `student_main_num`
--
ALTER TABLE `student_main_num`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `supervision_activity`
--
ALTER TABLE `supervision_activity`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `supervision_activity_rate`
--
ALTER TABLE `supervision_activity_rate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `supervision_teachtable`
--
ALTER TABLE `supervision_teachtable`
...
--
-- AUTO_INCREMENT for table `system_khet`
--
ALTER TABLE `system_khet`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=248;

--
-- AUTO_INCREMENT for table `system_menugroup`
--
ALTER TABLE `system_menugroup`
...
--
-- AUTO_INCREMENT for table `system_school`
--
ALTER TABLE `system_school`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `system_school_group`
--
ALTER TABLE `system_school_group`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `system_smss_permission`
--
ALTER TABLE `system_smss_permission`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `system_sync_smss`
--
ALTER TABLE `system_sync_smss`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `system_sync_smss_2`
--
ALTER TABLE `system_sync_smss_2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `warroom_permission`
--
ALTER TABLE `warroom_permission`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

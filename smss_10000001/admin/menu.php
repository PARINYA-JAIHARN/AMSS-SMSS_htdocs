...
<ul id="nav" class="dropdown dropdown-horizontal">
	...
	<li><a href="?file=sync_code" class="dir">การเชื่อมกับระบบอื่น</a>
		<ul>
			<li><a href="?file=sync_code">เชื่อมกับระบบอื่น ๆ</a></li>
		</ul>
	</li>
	<li><a href="./" class="dir">การบริการข้อมูล</a>
		<ul>
			<li><a href="?file=data_requester">หน่วยงานใช้ข้อมูล</a></li>
			<li><a href="?file=data_requester_log">รายงานการให้บริการ</a></li>	
		</ul>
	</li>

...
echo "<Tr><Td align='right'>Icon เมนู&nbsp;&nbsp;&nbsp;&nbsp;</Td><Td align='left'><Select name='menu_pic' size='1'>";
echo  "<option  value = ''>เลือก</option>" ;
echo  "<option value = 'alert' $select_alert>alert</option>";
echo  "<option value = 'asterisk' $select_asterisk>asterisk</option>";
echo  "<option value = 'bitcoin' $select_bitcoin>bitcoin</option>";
echo  "<option value = 'book' $select_book >book</option>";
echo  "<option value = 'education' $select_education>education</option>";
echo  "<option value = 'erase' $select_erase>erase</option>";
echo  "<option value = 'envelope' $select_envelope>envelope</option>";
echo  "<option value = 'filter' $select_filter>filter</option>";
echo  "<option value = 'file' $select_file>file</option>";
echo  "<option value = 'home' $select_home>home</option>";
echo  "<option value = 'info-sign' $select_info>info-sign</option>";
echo  "<option value = 'pencil' $select_pencil>pencil</option>";
echo  "<option value = 'question-sign' $select_question>question-sign</option>";
echo  "<option value = 'road' $select_road>road</option>";
echo  "<option value = 'th-large' $select_large>th-large</option>";
echo  "<option value = 'th-list' $select_list>th-list</option>";
echo  "<option value = 'user' $select_user>user</option>";
echo  "<option value = 'warning-sign' $select_warning>warning-sign</option>";
echo  "<option value = 'briefcase' $select_briefcase>กระเป๋าเดินทาง</option>";
echo  "<option value = 'usd' $select_usd>ดอลลาร์</option>";
echo  "<option value = 'star-empty' $select_star>ดาว</option>";
echo  "<option value = 'wrench' $select_wrench>เครื่องมือช่าง</option>";
echo "</select>";
echo "</Td></Tr>";
...
echo "<Tr bgcolor='#E6E6E6'><Td  align='center' width='50'>ที่</Td><Td  align='center'>กลุ่ม</Td><Td  align='center' width='170'>ชื่อระบบงานย่อย(อังกฤษ)</Td><Td  align='center'>ชื่อระบบงานย่อย(ไทย)</Td><Td  align='center'>ประเภท</Td><Td align='center'  width='50'>ลำดับ</Td><Td align='center'  width='90'>สถานะใช้งาน</Td><Td align='center' width='100'>การใช้งาน</Td><Td align='center'  width='70'>Icon เมนู</Td><Td align='center'  width='50'>ลบ</Td><Td align='center' width='50'>แก้ไข</Td></Tr>";

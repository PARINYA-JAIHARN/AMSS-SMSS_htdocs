...
$surname = explode(".", $_FILES['userfile']['name']);
		...
		$data=file("$changed_name");  
				...
				list($person_id,$prename,$name,$surname,$position_code) = explode("\t",$data[$i]);	
						if($person_id!=""){
						$sql = "insert into person_main (person_id,prename,name,surname,position_code,status,officer,rec_date) values ('$person_id','$prename','$name','$surname','$position_code','0','','0000-01-01')";

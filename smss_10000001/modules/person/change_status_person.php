...
echo "<Tr align='left'><Td width=30></Td><Td align='right'><b>เลขประจำตัวประชาชน</b>&nbsp;</Td><Td>$result[person_id]</Td></Tr>";
echo "<Tr align='left'><Td width=30></Td><Td align='right'><b>คำนำหน้าชื่อ</b>&nbsp;</Td><Td>$result[prename]</Td></Tr>";
echo "<Tr align='left'><Td ></Td><Td align='right'><b>ชื่อ</b>&nbsp;</Td><Td>$result[name]</Td></Tr>";
echo "<Tr align='left'><Td ></Td><Td align='right'><b>นามสกุล</b>&nbsp;</Td><Td>$result[surname]</Td></Tr>";
$post=$position_ar[$result['position_code']];
echo "<Tr align='left'><Td ></Td><Td align='right'><b>ตำแหน่ง</b>&nbsp;</Td><Td>$post</Td></Tr>";
echo "<Tr align='left'><Td ></Td><Td align='right'><b>สถานะภาพ</b>&nbsp;&nbsp;&nbsp;&nbsp;</Td><Td>";
...
//จบแยกหน้า
$sql = "select * from person_main where status='0' order by position_code,person_order,id limit $start,$pagelen";

$dbquery = mysqli_query($connect,$sql);
echo  "<table width='85%' border='1' align='center' style='border-collapse: collapse'>";
echo "<Tr bgcolor='#E6E6E6' align='center'><td>เลือก</td><Td width='50'>ที่</Td><Td width='100'>เลขประชาชน</Td><Td>ชื่อ</Td><Td>ตำแหน่ง</Td><Td width='50'>รูปภาพ</Td></Tr>";
...
echo "<Tr bgcolor='#E6E6E6'><Td colspan='6'><input type='checkbox' name='allchk' id='allchk' onclick='CheckAll()'>เลือก/ไม่เลือกทั้งหมด &nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE='button' name='smb' value='ครูและบุคลากร(ที่เลือก)ให้เป็นอดีต' onclick='goto_index10()'></Td></Tr>";
echo "</Table>";
echo "</form>";
}
...
$dbquery = mysqli_query($connect,$sql);
echo  "<table width='85%' border='1' align='center' style='border-collapse: collapse'>";
echo "<Tr bgcolor='#E6E6E6' align='center'><Td width='50'>ที่</Td><Td width='100'>เลขประชาชน</Td><Td>ชื่อ</Td><Td>ตำแหน่ง</Td><Td width='50'>รูปภาพ</Td><Td  width='60'>สถานะ</Td><Td  width='60'>แก้ไข</Td></Tr>";
$N=(($page-1)*$pagelen)+1;  //*เกี่ยวข้องกับการแยกหน้า
$M=1;
while ($result = mysqli_fetch_array($dbquery))
	{

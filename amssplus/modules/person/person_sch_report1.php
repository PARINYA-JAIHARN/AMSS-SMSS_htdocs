...
$sql = "select * from person_sch_main where status='0' order by position_code,person_order,id limit $start,$pagelen";
}
...
if(($page==$totalpages) and ($_REQUEST['school_code']=="")){
echo "<br>";
echo "<table width='100%' border='0' align='center'>";
echo "<tr align='center'><td><font color='#006666' size='3'><strong>สรุปจำนวนครูและบุคลากรทางการศึกษา จำแนกตามตำแหน่ง</strong></font></td></tr>";
echo "</table>";
echo "<br>";
...
echo "<Tr  bgcolor='$color' align='center'><Td>$M</Td> <Td>$position_code</Td> <Td align=left>$position_name</Td><Td>$position_person_num</Td></Tr>";
$M++;
	}

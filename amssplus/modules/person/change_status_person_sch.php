...
function showResult(str) {
  ...
  xmlhttp.open("GET","modules/person/livesearch_3.php?q="+str,true);
  xmlhttp.send();
}

function showResult_2(str) {
  if (str.length==0) { 
    document.getElementById("livesearch").innerHTML="";
    document.getElementById("livesearch").style.border="0px";
    return;
  ...
  xmlhttp.open("GET","modules/person/livesearch_4.php?q="+str,true);
  xmlhttp.send();
}
</script>
<?php
...
echo "<tr><td align='right' colspan='2'>";
		?>
		ค้นหาโรงเรียน <input type="text" size="15" onkeyup="showResult_2(this.value)">

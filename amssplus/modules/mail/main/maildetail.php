...
?>
					<tr>
						<td align="left">&nbsp;<FONT SIZE="2"><?php echo $list;?>. </FONT><A HREF="modules/mail/upload_files/<?php echo $file_name;?>" title="คลิกเพื่อเปิดไฟล์แนบลำดับที่ <?php echo $list;?>" target="_BLANK"><FONT SIZE="2"><span style="text-decoration: none"><?php echo $file_des;?></span></FONT></A></td>
					</tr>
...
echo "<form Enctype=multipart/form-data id='frm2' name='frm2' action='?option=mail&task=main/maildetail' method='post'>";

$timestamp = mktime(date("H"), date("i"),date("s"), date("m") ,date("d"), date("Y"))  ;	
$ref_id_2 = $_SESSION['login_user_id'].$timestamp ;

...
?>
					<tr>
						<td align="left">&nbsp;<FONT SIZE="2"><?php  echo $list;?>. </FONT><A HREF="modules/mail/main/download.php?fileid=<?php  echo $file_name;?>&detail=<?php  echo $file_des;?>" title="คลิกเพื่อเปิดไฟล์แนบลำดับที่ <?php  echo $list;?>" target="_BLANK"><FONT SIZE="2"><span style="text-decoration: none"><?php  echo $file_des;?></span></FONT></A></td>
					</tr>

...
if(isset($alert)){	
if($alert==1 and $_SESSION['login_status']!=5 and $_SESSION['login_status']!=15){
?>
...
<?php		
	...
	echo "<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
			...
			if(isset($_SESSION['smss_mode'])){
				...
				echo "<td align='left' nowrap='nowrap' class='row2' height='18'>&nbsp;&nbsp;&nbsp;";
					if(isset($_SESSION['module_name_'.$_GET['option']])){

...
echo "<tr align='center'><td><font color='#006666' size='3'><strong>หน่วยงานผู้ใช้ข้อมูลจากระบบ AMSS++</strong></font></td></tr>";
echo "</table>";
}
...
echo "<Input Type=Hidden Name='data_name[]' Value='$result[data_name]'>";
$N++;
}
echo "</table>";
echo "</fieldset>";
...
$dbquery = mysqli_query($connect,$sql);
$ref_result = mysqli_fetch_array($dbquery);
echo "<Tr><Td align='right' width='50%'>ชื่อหน่วยงานผู้ขอข้อมูล(ไทย)&nbsp;&nbsp;</Td><Td align='left' width='50%'><Input Type='Text' Name='thai_requester' Size='30' value='$ref_result[thai_requester]'></Td></Tr>";
echo "<Tr><Td align='right' width='50%'>ip ของเครื่องComputer&nbsp;&nbsp;</Td><Td align='left' width='50%'><Input Type='Text' Name='requester_server_id' Size='20' value='$ref_result[requester_server_id]'></Td></Tr>";
echo "<Tr><Td align='right' width='50%'>Username(English)&nbsp;&nbsp;</Td><Td align='left' width='50%'>$ref_result[requester]</Td></Tr>";
echo "<Tr><Td align='right' width='50%'>Password&nbsp;&nbsp;</Td><Td align='left' width='50%'><Input Type='Text' Name='requester_password' Size='20' value='$ref_result[requester_password]'></Td></Tr>";
...
echo "<legend>&nbsp;<B>รายการ</B>: &nbsp;</legend>";
echo "<table>";
$sql = "select * from system_export_permission left join system_export_list on system_export_permission.data_name=system_export_list.data_name where system_export_permission.requester='$ref_result[requester]'";
$dbquery = mysqli_query($connect,$sql);
$N=1;
While($result = mysqli_fetch_array($dbquery)){
...
thai_requester='$_POST[thai_requester]', 
requester_server_id='$_POST[requester_server_id]',
requester_password='$_POST[requester_password]', 
status='$_POST[status]', 
rec_date='$rec_date', 
...
$dbquery = mysqli_query($connect,$sql);
$ref_result = mysqli_fetch_array($dbquery);
echo "<Tr><Td align='right' width='50%'>ชื่อหน่วยงานผู้ขอข้อมูล(ไทย)&nbsp;&nbsp;</Td><Td align='left' width='50%'><Input Type='Text' Name='thai_requester' Size='30' value='$ref_result[thai_requester]' readonly></Td></Tr>";
echo "<Tr><Td align='right' width='50%'>ip ของเครื่องComputer&nbsp;&nbsp;</Td><Td align='left' width='50%'><Input Type='Text' Name='requester_server_id' Size='20' value='$ref_result[requester_server_id]' readonly></Td></Tr>";
echo "<Tr><Td align='right' width='50%'>Username(English)&nbsp;&nbsp;</Td><Td align='left' width='50%'><Input Type='Text' Name='requester' Size='20' value='$ref_result[requester]' readonly></Td></Tr>";
echo "<Tr><Td align='right' width='50%'>Password&nbsp;&nbsp;</Td><Td align='left' width='50%'><Input Type='Text' Name='requester_password' Size='20' value='$ref_result[requester_password]' readonly></Td></Tr>";
...
if(isset($_REQUEST['page']))
	...
	echo "<Tr><Td colspan='7' align='left'><INPUT TYPE='button' name='smb' value='เพิ่มข้อมูล' onclick='location.href=\"?file=data_requester&index=1\"'</Td></Tr>";
	echo "</Table>";
	echo  "<table width='70%' border='1' align='center' style='border-collapse: collapse'>";
	echo "<Tr bgcolor='#E6E6E6'><Td  align='center' width='50'>ที่</Td><Td align='center'>ชื่อ</Td><Td align='center' width='150'>computer ip</Td><Td align='center' width='150'>รหัสเข้าถึงข้อมูล</Td><Td  align='center' width='50'>การ<br>อนุญาต</Td><Td align='center' width='50'>ราย<br>ละเอียด</Td><Td align='center' width='50'>ลบ</Td><Td align='center' width='50'>แก้ไข</Td></Tr>";
	...
	While ($result = mysqli_fetch_array($dbquery))
		{
			...
			$requester_password= $result['requester_password'];
			...
			echo "<Tr bgcolor=$color><Td align='center'>$N</Td><Td align='left'>$thai_requester ($requester)</Td><Td align='left'>$requester_server_id</Td><Td align='left'>$requester_password</Td><Td align='center'><a href=?file=data_requester&index=8&id=$id&status=$status&page=$page>$active_pic</a></Td>";
			...
			echo "<Td align='center'><a href=?file=data_requester&index=2&id=$id&page=$page><img src=../images/drop.png border='0' alt='ลบ'></a></Td>
			<Td align='center'><a href=?file=data_requester&index=5&id=$id&page=$page><img src=../images/edit.png border='0' alt='แก้ไข'></a></Td>
		</Tr>";
	$M++;

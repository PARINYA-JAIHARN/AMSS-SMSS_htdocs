...
echo "</Cener>";
echo "<Br><Br>";
echo "<Table width='50%' border='0' align='center' style='border-collapse: collapse'>";
$sql = "select  * from system_office_name";
$dbquery = mysqli_query($connect,$sql);
$result = mysqli_fetch_array($dbquery);
echo "<Tr bgcolor='#E6E6E6'><Td align='right'><b>ชื่อหน่วยงาน</b>&nbsp;&nbsp;&nbsp;&nbsp;</Td><Td align='left'><Input Type='Text' Name='office_name' Size='50' maxlength='70' value='$result[office_name]'></Td></Tr>";
...
echo "<Tr bgcolor='#E6E6E6'><Td align='center'>ชื่อหน่วยงาน</Td><Td align='center' width='50'>แก้ไข</Td></Tr>";
